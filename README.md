...
{
    "swarm": [{
        error_i	3.5567915301528563	float64,
        error_i_best	3.5567915301528563	float64,
        position_i	[0.9581224128162724, 2.5284571904175372]	list,
        position_i_best	[0.7238504823196498, 3.111126082879543]	list,
        velocity_i	[0.23427193049662265, -0.5826688924620057]	list
    }]
```
...
{
    "swarm": [{
        error_i	0.004096218913725794	float64,
        error_i_best	0.004096218913725794	float64,
        position_i	[-1.0166652560790046, 0.005918579715854832]	list,
        position_i_best	[-1.0021849423375173, 0.0034648284764024467]	list,
        velocity_i	[-0.014480313741487186, 0.002453751239452385]	list
    }]
```
